...
// etc.) â€” this makes that consistent and enforced at the router instead of
...
export default function RequireAuth({ children }) {
  ...
  if (loading) return null // AuthProvider is still resolving the initial session â€” avoid a flash-redirect
