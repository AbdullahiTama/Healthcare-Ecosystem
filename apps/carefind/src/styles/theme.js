...
export const theme = {
  ...
  type: {
    display: { size: 30, weight: 900, lineHeight: 1.12, letterSpacing: '-0.035em' },
    h1: { size: 24, weight: 900, lineHeight: 1.2, letterSpacing: '-0.025em' },
    h2: { size: 20, weight: 800, lineHeight: 1.25, letterSpacing: '-0.015em' },
    h3: { size: 16.5, weight: 800, lineHeight: 1.3, letterSpacing: '-0.01em' },
