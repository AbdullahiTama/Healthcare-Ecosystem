...
export const STATUS_CONFIG = {
  ...
  ready_for_pickup: { label: 'Ready for Pickup', icon: MapPin, color: theme.tealDeep, step: 5 },
  in_transit: { label: 'In Transit', icon: Truck, color: theme.tealDeep, step: 6 },
  delivered: { label: 'Delivered', icon: CheckCircle, color: theme.success, step: 7 },
