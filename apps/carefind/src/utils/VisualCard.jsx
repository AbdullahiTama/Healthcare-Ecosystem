...
export const CARD_TEMPLATES = {
  'teal-depth': {
    label: '🌊 Ocean',
    background: 'linear-gradient(135deg, #0E6F5A 0%, #1A8A72 100%)',
    color: '#FFFFFF',
  },
  'navy-clinical': {
    label: '✨ Sky',
    background: 'linear-gradient(135deg, #0B4A3E 0%, #155A4B 100%)',
    color: '#FFFFFF',
  },
  'midnight-teal': {
    label: '🌃 Night',
  ...
  return (
    <div
      style={{
        ...
        width: '100%',
        aspectRatio: '1 / 1',
        background: imageUrl ? `#0B4A3E url(${imageUrl}) center/cover` : t.background,
        borderRadius: 16,
        overflow: 'hidden',
        display: 'flex',
        alignItems: 'center',
    ...
    >
      ...
      >
        <svg
          ...
          style={{ flexShrink: 0 }}
        >
          <path d="M32 6C23.163 6 16 13.163 16 22c0 11.25 16 30 16 30s16-18.75 16-30C48 13.163 40.837 6 32 6z" fill="#0E6F5A" />
