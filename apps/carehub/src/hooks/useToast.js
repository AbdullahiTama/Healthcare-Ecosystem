...
// ── USE TOAST HOOK ────────────────────────────────────────────────────────────
// Moved out of components/ui/index.jsx — pure state/behavior, no JSX, belongs
// in hooks/. Re-exported from the ui barrel so existing `import { useToast }
// from '.../components/ui'` call sites keep working unchanged.
//
...
// for the Undo pattern (docs/design/SCREEN_PATTERNS.md → "Reversible
// actions get undo, not a confirmation dialog"), not arbitrary buttons.
